    ...
    <>
      ...
      >
        <form className="mx-auto" action="submit">
          ...
          <div className="pt-4">
            <input
              className="w-5/6 md:w-2/4 lg:w-1/3 h-10 mx-auto rounded-lg bg-white focus:outline-white  block pl-3"
              type="email"
              placeholder="Email address"
            />
            <input
              className="w-5/6 md:w-2/4 lg:w-1/3 h-10 mx-auto rounded-lg bg-white focus:outline-white  block my-4 pl-3"
              type="text"
              placeholder="Subject"
            />
            <textarea
